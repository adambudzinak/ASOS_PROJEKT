### SPUSTENIE
Pred spustenim sa treba uistit, ze mas node (v22.20.0), npm, postgresql
...
## STRUKTURA PROJEKTU
index - cast aplikacie spolocna pre vsetkych (registrovanych/prihlasenych aj neregistrovanych/neprihlasenych)
